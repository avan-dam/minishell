...
/*   Updated: 2021/04/13 20:51:51 by ambervandam   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	free_set_ret(char *oldvar, char *newvar, t_line *s)
{
	int	retval;
...
int	ft_find_dolla(int i, int j, t_mini *mini, t_line *s)
{
	...
	retval = free_set_ret(oldvar, newvar, s);
	free(s->str);
